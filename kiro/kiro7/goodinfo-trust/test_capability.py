...
class TestScraperCapabilityAST(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        with patch("subprocess.run") as mock_sub:
            ...
            cls.inspect_ast_for_chart_script = staticmethod(cls.goodinfo_trust_run.inspect_ast_for_chart_script)
...
'''
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch.dict(os.environ, {"TEMP": tmpdir}):
                with patch.object(self.goodinfo_trust_run, "check_scraper_capability") as mock_check_cap:
                    ...
                    self.assertGreaterEqual(mock_sub.call_count, 6, "應至少調用 6 次 subprocess.run 執行 pipeline 步驟")
    ...
    def test_main_step_failure_exits_nonzero(self, mock_sub):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch.dict(os.environ, {"TEMP": tmpdir}):
                with patch.object(self.goodinfo_trust_run, "check_scraper_capability"):
